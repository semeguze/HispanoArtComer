...
public class FirstTimeView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("ACKI", "isInfoComplete (onCreate en FirstTimeView)-> " + prefManager.isInfoComplete());
        ...
        setContentView(R.layout.activity_first_time_view);
