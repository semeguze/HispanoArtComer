...
//        coinText.setTypeface(tb);
        ...
        countDownTimer = new CountDownTimer(22000, 1000) {
            ...
            public void onFinish() {
                ...
                timeUp(coinText.getText().toString());
            }
        }.start();
    ...
    public void buttonA(View view) {
        ...
        if (currentQuestion.getOptA().equals(currentQuestion.getAnswer())) {
            ...
            //If user has exceeds the que limit just navigate him to GameWon activity
                ...
                String conis = coinText.getText().toString();
                gameWon(conis);
    ...
    public void gameWon(String coins) {
        Intent intent = new Intent(this, GameWon.class);
        intent.putExtra("stringCoins", coins);
    ...
    public void gameLostPlayAgain(String coins) {
    ...
    public void timeUp(String coins) {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, PuntosDetailsView.class);
        startActivity(intent);
        finish();
    }
